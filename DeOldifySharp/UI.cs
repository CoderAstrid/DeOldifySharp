...
namespace ColorfulSoft.DeOldify
{
    ...
    public sealed class HelpForm : Form
    {
        ...
        public HelpForm() : base()
        {
            // this
            this.Text = "About";
            this.Icon = Icon.FromHandle((new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Info.png"))).GetHicon());
            ...
            this.__Preview.Image = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Preview.jpg"));
    ...
    public sealed class MainForm : Form
    {
        ...
        public MainForm() : base()
        {
            ...
            var hIcon = Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Icon.png");
            this.Icon = Icon.FromHandle((new Bitmap(hIcon)).GetHicon());
            this.BackColor = SystemColors.ControlDarkDark;
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            ...
            this.__HelpButton.Image = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Info.png"));
            ...
            this.__InputBox.ForeColor = SystemColors.Control;
              ...
              this.__SetInputImage(new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Input.jpg")));
            ...
            this.__OutputBox.ForeColor = SystemColors.Control;
              ...
              this.__SetOutputImage(new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.Output.jpg")));
            ...
            //
            this.__ColorfulSoftLogo = new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("DeOldifySharp.Resources.ColorfulSoft.png"));
            //
